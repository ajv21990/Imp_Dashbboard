  ...
  function getPostmanRequest(store,name,product) {
    ...
    let postmanRequest = {
      ...
      "agreementsSigned": [
        ...
        "MkAgrPersonalGuarantee",
        "MkAgrNaturalPersonCertification",
        "MkAgrAuthorizedUserCertification"
      ],
      "balanceTransfers": [],
      "comments": "",
      "customFields": [],
      "parties": [
        {
          "partyType": "PtyOrganization",
          "roleTypeId": [
              "PrimaryApplicant"
          ],
          "organizationName": "IRRATIONAL GAMES  LLC",
          "dbaName": "",
          "businessStructure": "Corporation",
          "taxIdentificationNumber": "011654345",
          "dateOfBusinessFormation": "2000-12-09",
          "numEmployees": "50",
          "annualRevenue": "120000",
          "countryFormation": "USA",
          "countryPrimaryActivity": "USA",
          "naicsCode": "491110",
          "stateLegalFormation": "USA_CA",
          "contactInformation": [
              {
                  "postalContactMechPurposeId": "PostalBilling",
                  "address1": "1515 QUINCY HANCOCK ST FL 3",
                  "address2": "",
                  "city": "Quincy",
                  "stateProvinceGeoId": "USA_MA",
                  "postalCode": "02169"
              },
              {
                  "telecomPrimary": true,
                  "telecomContactMechPurposeId": "PhonePrimary",
                  "contactNumber": "6176570799"
              }
          ]
      },
      {
        ...
        "contactInformation": [
            {
                "telecomPrimary": true,
                "telecomContactMechPurposeId": "PhonePrimary",
                "contactNumber": "4342342342"
            },
            {
                "emailContactMechPurposeId": "EmailPrimary",
                "emailAddress": "anthony.villanueva+BizContact@mkdecision.com"
            }
        ],
        "partyType": "PtyPerson",
        "roleTypeId": [
      ...
      "relationships": [],
      "accountName": "IRRATIONAL GAMES  LLC",
    }
...
<br/>
    ...
    {props.alphaStoreState === "Biz Alpha" ? (
      <div>
        ...
        >
          <option aria-label="None" value="" />
          <option value={props.products[0][2].productID}>{props.products[0][2].productName}</option>
          <option value={props.products[0][3].productID}>{props.products[0][3].productName}</option>
          <option value={props.products[0][4].productID}>{props.products[0][4].productName}</option>
          <option value={props.products[0][5].productID}>{props.products[0][5].productName}</option>
      ...
      <div>
        ...
        >
          <option aria-label="None" value="" />
          <option value={props.products[1][3].productID}>{props.products[1][3].productName}</option>
          <option value={props.products[1][4].productID}>{props.products[1][4].productName}</option>
        </Select>
        </div>
    ) : null}
      ...
      <div>
        ...
        >
          <option aria-label="None" value="" />
          <option value={props.products[2][2].productID}>{props.products[0][2].productName}</option>
        </Select>
        </div>
    ) : null}
        ...
        >
          <option aria-label="None" value="" />
          <option value={props.products[3][4].productID}>{props.products[3][4].productName}</option>
          <option value={props.products[3][5].productID}>{props.products[3][5].productName}</option>
          <option value={props.products[3][6].productID}>{props.products[3][6].productName}</option>
          <option value={props.products[3][7].productID}>{props.products[3][7].productName}</option>
        </Select>
        </div>
    ) : null}
      ...
      <div>
        ...
        >
          <option aria-label="None" value="" />
          <option value={props.products[4][2].productID}>{props.products[4][2].productName}</option>
        </Select>
        </div>
    ) : null}
    <br/>
